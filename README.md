...
**Why-first とは:** 機能の「使い方（How）」より先に、「なぜその仕組みが言語に必要なのか（Why）」を説明する編集方針です。たとえばライフタイムの記法を覚えさせる前に、borrow チェッカーが何を防ごうとしているのかを伝えます。記号の暗記ではなく、仕組みの理由から理解できることを目指します。
...
| **言語別** | Go、Python、TypeScript、C、C++、Javaなど、使ってきた言語を足がかりにRustを基礎から学ぶ。既存言語との差分は、理解を助ける橋渡しとして使う |
